...
public class Main {
    public static void main(String[] args) {
        ...
        List<Student> students = List.of(
                ...
                new Student("Alex", List.of(books.get(0), books.get(2), books.get(4), books.get(6), books.get(8))),
                new Student("Elena", List.of(books.get(1), books.get(3), books.get(5), books.get(7), books.get(9)))
        );
